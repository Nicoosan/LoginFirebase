...
<TextInput style={estilo.campo} onChangeText={(email) => setEmail(email)} value={email}
placeholder="Digite o seu Email" required /> 

<TextInput style={estilo.campo} secureTextEntry={true} onChangeText={(senha)=> setSenha( senha)}
value={senha} placeholder="Digite a sua Senha" required />
